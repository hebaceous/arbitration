...
<form id="pagerForm" method="post" action="${pageContext.request.contextPath }/flow/17List/${user.id }">
</form>
	...
	<table class="list" width="98%" targetType="navTab" layoutH="116">
		...
		<tbody>
			...
			<tr>
				...
				<td>
					<a title="填写裁决书" target="dialog" mask="true" max="true" href="${pageContext.request.contextPath }/flow/17/${c.id }">填写裁决书</a>
				</td>
			</tr>
			</c:forEach>
		</tbody>
