...
<form method="post" action="${pageContext.request.contextPath }/flow/6receivedReceipt/${receipt.id }" class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone);">
<div layoutH="56">
