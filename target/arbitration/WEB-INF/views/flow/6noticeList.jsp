...
<form id="pagerForm" method="post" action="${pageContext.request.contextPath }/flow/6noticeList/${user.id }">
</form>
	...
	<table class="list" width="98%" targetType="navTab" layoutH="116">
		...
		<tbody>
			...
			<tr>
				...
				<td>
					<a title="送达文书" target="dialog" mask="true" href="${pageContext.request.contextPath }/flow/6notice/${receipt.id }">送达文书</a>
				</td>
			</tr>
			</c:forEach>
		</tbody>
