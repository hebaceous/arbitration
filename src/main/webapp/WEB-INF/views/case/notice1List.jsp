...
<form id="pagerForm" method="post" action="${pageContext.request.contextPath }/case/notice1List">
	...
	<table class="list" width="100%" targetType="navTab" layoutH="26">
		...
		<tbody>
			...
			<tr>
				...
				<td>
					<a title="打印受理通知书" target="navTab" href="${pageContext.request.contextPath }/case/notice1/${c.id }">打印受理通知书</a>
				</td>
			</tr>
			</c:forEach>
		</tbody>
