...
<form id="pagerForm" method="post" action="${pageContext.request.contextPath }/case/costList">
</form>
	...
	<table class="list" width="98%" targetType="navTab" layoutH="116">
		...
		<tbody>
			...
			<tr>
				...
				<th>${c.user.name }</th>
				<td>
					<a title="更改费用" target="dialog" mask="true" href="${pageContext.request.contextPath }/case/cost/${c.id }">更改费用</a>
				</td>
			</tr>
			</c:forEach>
		</tbody>
