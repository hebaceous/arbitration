...
<form id="pagerForm" method="post" action="${pageContext.request.contextPath }/flow/5List/${user.id }">
</form>
	...
	<table class="list" width="98%" targetType="navTab" layoutH="116">
		...
		<tbody>
			...
			<tr>
				...
				<td>
					<a title="送达回证" target="dialog" mask="true" max="true" href="${pageContext.request.contextPath }/flow/5/${c.id }">送达回证</a>
				</td>
			</tr>
			</c:forEach>
		</tbody>
