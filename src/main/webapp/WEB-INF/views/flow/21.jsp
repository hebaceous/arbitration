...
<form method="post" action="${pageContext.request.contextPath }/flow/21/${c.id }" class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone);">
